		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-2 col-md-8">
					<p class="larger-text">Interested about hiring us ? Go ahead and talk with us on the <a href="contact.jsp">contact page</a>. We'll be pleased to answer you within a few hours.</p>
				</div> <!-- /.col-md-8 -->
			</div> <!-- /.row -->
		</div> <!-- /.container -->
						...
						<div class="thumb-post">
                            ...
                            <div class="overlay-inner">
                                <div class="portfolio-infos">
                                    ...
                                    <h3 class="portfolio-title"><a href="project-slideshow.jsp">Ion Template</a></h3>
                                </div>
                                <div class="portfolio-expand">
						...
						<div class="thumb-post">
                            ...
                            <div class="overlay-inner">
                                <div class="portfolio-infos">
                                    ...
                                    <h3 class="portfolio-title"><a href="project-slideshow.jsp">Freshness</a></h3>
                                </div>
                                <div class="portfolio-expand">
